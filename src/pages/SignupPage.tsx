...
const SignupPage: React.FC<SignupPageProps> = ({ onNavigateHome, onNavigateLogin }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({ general: firebaseError.message || 'Signup failed. Please try again.' });
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      const firebaseError = error as FirebaseError;
      setErrors({ general: firebaseError.message || 'Google sign-in failed. Please try again.' });
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <Navbar 
        ...
        onLoginAction={onNavigateLogin}
        onSignupAction={() => {}} // Already on signup page
        currentPage="signup"
      />
